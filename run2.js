...
// Fungsi untuk mendapatkan poin secara real-time
...
const joinMeeting = async (roomId, displayName) => {
  try {
    ...
    // Tambahkan delay untuk memastikan koneksi WebSocket stabil sebelum join room
    logger.loading('Waiting for WebSocket to stabilize...');
    ...
    // Mulai pemantauan poin real-time
